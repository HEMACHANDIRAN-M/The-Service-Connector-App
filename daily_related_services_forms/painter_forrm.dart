...
class PainterForrm extends StatefulWidget {
  const PainterForrm({super.key});

  @override
  State<PainterForrm> createState() => _PainterFormState();
}

class _PainterFormState extends State<PainterForrm> {
  List<String> selectedPainterType = [];
            ...
            children: [
              ...
              InkWell(
                onTap: () async {
                  ...
                  if (results != null) {
                    setState(() {
                      selectedPainterType = results;
                      digitalThings.text = selectedPainterType.join(", ");
                    });
                  }
                },
                child: IgnorePointer(
