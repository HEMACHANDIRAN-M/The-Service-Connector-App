...
class ArrearPaperForm extends StatefulWidget {
  const ArrearPaperForm({super.key});

  @override
  State<ArrearPaperForm> createState() => _ArrearpaperFormState();
}

class _ArrearpaperFormState extends State<ArrearPaperForm> {
  List<String> selectedSubjectTypes = [];
  ...
  List<String> SubjectType = [
    "Engineering Subjets",
    "Arts & Science Subjects",
    "Diplomo Subjects",
    "Others",
  ];
  List<String> PackagesIncluded = [
    "Subjects Notes",
    "Past Year Question Paper Discussion",
    "Practice Tests",
    "Weeky Doubt clarification",
  ...
  List<String> UniversityOrSyllabus = [
  ...
  TextEditingController subjectType = TextEditingController();
  ...
  TextEditingController universityOrSyllabus = TextEditingController();
            ...
            children: [
              ...
              InkWell(
                onTap: () async {
                  ...
                  if (results != null) {
                    setState(() {
                      selectedSubjectTypes = results;
                      serviceType.text = selectedSubjectTypes.join(", ");
                    });
                  }
                },
                child: IgnorePointer(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      labelText: "Subject Type (multi-select)",
                      border: OutlineInputBorder(),
                      prefix: Icon(Icons.star, color: Colors.red),
              ...
              InkWell(
                ...
                child: IgnorePointer(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      labelText:
                          "Choose University Or Syllabus ?(multi-select)",
                      border: OutlineInputBorder(),
                      prefix: Icon(Icons.star, color: Colors.red),
                      suffixIcon: Icon(Icons.arrow_drop_down),
                    ),
