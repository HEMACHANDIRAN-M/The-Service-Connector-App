...
class SpecialClassForm extends StatefulWidget {
  const SpecialClassForm({super.key});

  @override
  State<SpecialClassForm> createState() => _SkillBasedFormState();
}

class _SkillBasedFormState extends State<SpecialClassForm> {
  List<String> selectedStandardTypes = [];
  ...
  List<String> selectedBoardOfEducation = [];
  ...
  List<String> BoardOfEducation = [
    "State Board(Tamil Nadu)",
    "CBSE",
    "Matriculation /ICSE",
    "Others",
  ];
  List<String> StandardType = [
    "LKG/UKG",
    "Class 1-5",
    "Class 6-8 ",
    "Class 9-10",
  ...
  void submitForm() async {
    Map<String, dynamic> data = {
      ...
      "skillType": standardType.text,
      "BoardOfEducation": boardOfEducation.text,
  ...
  TextEditingController standardType = TextEditingController();
  ...
  TextEditingController boardOfEducation = TextEditingController();
            ...
            children: [
              ...
              InkWell(
                onTap: () async {
                  ...
                  if (results != null) {
                    setState(() {
                      selectedStandardTypes = results;
                      standardType.text = selectedStandardTypes.join(", ");
                    });
                  }
                },
                child: IgnorePointer(
                  child: TextField(
                    controller: standardType,
                    decoration: InputDecoration(
                      labelText: "Standard Type (multi-select)",
                      border: OutlineInputBorder(),
                      prefix: Icon(Icons.star, color: Colors.red),
