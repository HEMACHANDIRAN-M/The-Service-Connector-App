...
import 'package:connectorapp/daily_related_services_forms/parlour_form.dart';
import 'package:flutter/material.dart';
import 'package:lottie/lottie.dart';

class ParlourAddPage extends StatefulWidget {
  const ParlourAddPage({super.key});

  @override
  State<ParlourAddPage> createState() => _ParlourAddPageState();
}

class _ParlourAddPageState extends State<ParlourAddPage> {
  @override
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => ParlourForm()),
          );
        },
      ),
      appBar: AppBar(
