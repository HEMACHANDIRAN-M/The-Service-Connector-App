...
import 'package:connectorapp/coaching_based_forms/gov_exam_form.dart';
import 'package:flutter/material.dart';
import 'package:lottie/lottie.dart';

class GovExamAddPage extends StatefulWidget {
  const GovExamAddPage({super.key});

  @override
  State<GovExamAddPage> createState() => _GovExamAddPageState();
}

class _GovExamAddPageState extends State<GovExamAddPage> {
  @override
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => GovExamForm()),
          );
        },
      ),
      appBar: AppBar(
