...
import 'package:connectorapp/language_related_forms/tamil_form.dart';
import 'package:flutter/material.dart';
import 'package:lottie/lottie.dart';

class TamilAddPage extends StatefulWidget {
  const TamilAddPage({super.key});

  @override
  State<TamilAddPage> createState() => _TamilAddPageState();
}

class _TamilAddPageState extends State<TamilAddPage> {
  @override
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => TamilForm()),
          );
        },
      ),
      appBar: AppBar(
