...
import 'package:connectorapp/language_related_forms/english_form.dart';
import 'package:flutter/material.dart';
import 'package:lottie/lottie.dart';

class EnglishAddPage extends StatefulWidget {
  const EnglishAddPage({super.key});

  @override
  State<EnglishAddPage> createState() => _EnglishAddPageState();
}

class _EnglishAddPageState extends State<EnglishAddPage> {
  @override
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => EnglishForm()),
          );
        },
      ),
      appBar: AppBar(
