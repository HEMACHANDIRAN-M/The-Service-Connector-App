...
class VideographyForm extends StatefulWidget {
  const VideographyForm({super.key});

  @override
  State<VideographyForm> createState() => _VideographyFormState();
}

class _VideographyFormState extends State<VideographyForm> {
  List<String> selectedVideoTypes = [];
  ...
  List<String> Videotype = [
    "Traditional Full Video",
    "Cinematic Highlight Video",
    "Drone Shots",
    "Teaser Video",
    "Live Streaming",
    "Short Reels",
    "All Styles of Videography Available",
  ];
